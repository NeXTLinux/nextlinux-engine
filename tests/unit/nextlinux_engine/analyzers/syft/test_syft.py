...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/test_syft.py
from nextlinux_engine.analyzers.syft.adapters import (
    _convert_syft_to_engine,
========
from nextlinux_engine.analyzers.gosbom.adapters import (
    _convert_gosbom_to_engine,
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/test_syft.py
    _filter_artifacts,
)
...
class TestConvertGosbomToEngine:
    ...
    def test_filter_artifact_by_type(self, test_sbom, enable_package_filtering):
        findings = _convert_gosbom_to_engine(test_sbom, enable_package_filtering)
