...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/handlers/test_npm.py
from nextlinux_engine.analyzers.syft.handlers.npm import save_entry
========
from nextlinux_engine.analyzers.gosbom.handlers.npm import save_entry
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/handlers/test_npm.py
            ...
            pytest.param(
                {
                    ...
                    "expected_key": "/virtual/npmpkg/test-1.0.0",
                },
            ...
            pytest.param(
                {
                    ...
                    "expected_key": "/virtual/npmpkg/test-1.0.1",
                },
