...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/handlers/test_alpine.py
from nextlinux_engine.analyzers.syft.handlers.alpine import save_entry, _all_packages
========
from nextlinux_engine.analyzers.gosbom.handlers.alpine import save_entry, _all_packages
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/handlers/test_alpine.py
