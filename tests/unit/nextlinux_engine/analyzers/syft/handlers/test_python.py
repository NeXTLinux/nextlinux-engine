...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/handlers/test_python.py
from nextlinux_engine.analyzers.syft.handlers.python import save_entry
========
from nextlinux_engine.analyzers.gosbom.handlers.python import save_entry
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/handlers/test_python.py
