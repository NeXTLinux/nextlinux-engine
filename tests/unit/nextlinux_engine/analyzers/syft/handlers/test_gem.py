...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/handlers/test_gem.py
from nextlinux_engine.analyzers.syft.handlers.gem import save_entry
========
from nextlinux_engine.analyzers.gosbom.handlers.gem import save_entry
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/handlers/test_gem.py
            ...
            pytest.param(
                {
                    ...
                    "expected_key": "/virtual/gempkg/test-1.0.0",
                },
            ...
            pytest.param(
                {
                    ...
                    "expected_key": "/virtual/gempkg/test-1.0.1",
                },
