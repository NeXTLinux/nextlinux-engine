...
class TestBaseHint:
    ...
    def test_check_required_fields(self, param):
        ...
        if param["expected_error"]:
            with pytest.raises(HintsTypeError,
                               match=r"%s" % param["expected_error"]):
            ...
            pytest.param(
                {
                    ...
                    None,
                    "expected_error":
                    "hints package version for hints package \\(zlib\\) is not valid for RPM package type",
                },
            ...
            pytest.param(
                {
                    ...
                    "expected_error":
                    "bad hints record \\(pytest\\), files, if specified must be list type",
                },
                id="invalid-files",
            ),
        ],
            ...
            pytest.param(
                {
                    "pkg": {
                        ...
                        "version": "v0.1.8",
                        "origin":
                        "Nextlinux Engineering <engineering@next-linux.systems>",
                        "license": "Apache2.0",
                        "arch": "x86_64",
                        "source": "rem",
                        "size": "101010",
            ...
            pytest.param(
                {
                    ...
                    "expected_error":
                    "bad hints record \\(busybox\\), files, if specified must be list type",
                },
                id="invalid-files",
            ),
        ],
            ...
            pytest.param(
                {
                    "pkg": {
                        ...
                        "version": "1:1.2.8.dfsg-5",
                        "origin":
                        "Mark Brown <broonie@debian.org> (maintainer)",
                        "license": "Unknown",
                        "arch": "unknown",
                        "release": "releasetest",
                        "source": "sourctest",
            ...
            pytest.param(
                {
                    ...
                    "expected": {},
                    "expected_error":
                    "hints package version for hints package \\(zlib\\) is not valid for APKG package type",
                },
            ...
            pytest.param(
                {
                    "pkg": {
                        "name": "rubylib",
                        "version": "1.0.0",
                        "origin": "Nextlinux <nextlinux@next-linux.systems>",
                        "license": "Apache2.0",
                        "source": "sourctest",
                        "files": [
                            "file1",
            ...
            pytest.param(
                {
                    ...
                    "expected": {},
                    "expected_error":
                    "bad hints record \\(rubylib\\), versions, licenses, origins, and files if specified must be list types",
                },
            ...
            pytest.param(
                {
                    "pkg": {
                        "name": "rubylib",
                        "version": "1.0.0",
                        "origins": "Nextlinux <nextlinux@next-linux.systems>",
                        "license": "Apache2.0",
                        "source": "sourctest",
                        "files": [
                            "file1",
            ...
            pytest.param(
                {
                    ...
                    "expected": {
                        "location": "/virtual/gempkg/rubylib-1.0.0"
                    },
                    "expected_error": "",
                },
            ...
            pytest.param(
                {
                    ...
                    "expected": {},
                    "expected_error":
                    "bad hints record \\(nodelib\\), versions, licenses, origins, and files if specified must be list types",
                },
                id="invalid-version-with-location",
            ),
            pytest.param(
            ...
            pytest.param(
                {
                    ...
                    "expected": {
                        "location": "/virtual/npmpkg/nodelib-1.0.0"
                    },
                    "expected_error": "",
                },
                id="valid-without-location",
