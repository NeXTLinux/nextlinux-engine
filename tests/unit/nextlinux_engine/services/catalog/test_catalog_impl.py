            ...
            pytest.param(
                {
                    ...
                    "docker.io/nextlinux/kai@sha256:714511030a442b48f37791a817ce6e124d9ea4b0158f93ce914520549bd6bc30",
                },
            ...
            pytest.param(
                {
                    ...
                    catalog_impl.ImageKey(
                        ...
                        digest=""),
                    "expected":
                    "docker.io/nextlinux/test_images:centos8",
                },
                id="no-digest",
            ),
            pytest.param(
            ...
            pytest.param(
                {
                    ...
                    "expected":
                    "docker.io/nextlinux/test_images@sha256:1234abcd",
                },
            ...
            pytest.param(
                {
                    ...
                    "expected":
                    "nexus.aveng.me:5000/beats/filebeat@sha256:1b5677e1cc3ad16dd700a1d61e488ffdc5",
                },
