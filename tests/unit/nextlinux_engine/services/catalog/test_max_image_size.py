...
max_image_size_tests = [
    {
        ...
        "get_config": lambda: {
            "max_compressed_image_size_mb": 700
        },
        "is_valid": True,
    },
    {
        ...
        "get_config": lambda: {
            "max_compressed_image_size_mb": 200
        },
        "is_valid": False,
    },
    {
        ...
        "get_config": lambda: {
            "max_compressed_image_size_mb": None
        },
        "is_valid": True,
    },
    {
    ...
    },
    {
        "image_info": {},
        "get_config": lambda: {
            "max_compressed_image_size_mb": 300
        },
        "is_valid": True,
    },
]
...
def test_is_image_valid_size(mock_config, test_context):
    ...
    assert is_image_valid_size(
        test_context["image_info"]) == test_context["is_valid"]
