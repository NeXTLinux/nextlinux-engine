...
class TestBuildOsResponse:
    ...
    def content_data_entry(self):
        return {
            ...
            "GPLv2+",
            "origin":
            "APT Development Team <deity@lists.debian.org> (maintainer)",
            "release":
            "N/A",
            "size":
            "4064000",
    ...
    def test_multi_license(self, multi_license_content_data):
        ...
        actual_response = _build_os_response(
            {"apt": multi_license_content_data})
...
class TestBuildNpmResponse:
    ...
    def test_go_case(self, content_data_entry):
        expected_response = [{
            ...
            "location":
            "/usr/local/lib/node_modules/npm/docs/package.json",
            "origin":
            "Tanya Brassie <tanyabrassie@tanyascmachine2.home>",
            "package":
            "npm-cli-docs",
            "type":
            "NPM",
...
class TestBuildPythonResponse:
    ...
    def content_data_entry(self):
        return {
            ...
            "pip",
            "origin":
            "The pip developers <pypa-dev@groups.google.com>",
            "type":
            "python",
            "version":
            "20.0.2",
...
class TestBuildGemResponse:
    ...
    def test_go_case(self, content_data_entry):
        expected_response = [{
            ...
            "licenses": ["MIT"],
            "location":
            "/usr/local/lib/ruby/gems/2.7.0/specifications/rake-13.0.1.gemspec",
            "origin":
...
class TestBuildJavaResponse:
    ...
    def content_data_entry(self):
        return {
            ...
            "N/A",
            "metadata": {
                "MANIFEST.MF": "(truncated manifest data)"
            },
            "name":
            "charsets",
            "origin":
