...
def test_tag_source_validator():
    ...
    api_utils.validate_tag_source(
        tag_source={"pullstring": "docker.io/nginx:latest"},
        api_schema=api_spec)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "source": {
                    "archive": {
                        "digest":
                        "sha256:b9e8479820fb3a1a2f8ec426dd4ffc129e3a320392ce28dde6ae2d2d29ce2682"
                    }
                }
            },
            {
        ...
        # Malformed tag
        ({
            "tag": "docker.io/library/nginx@{}".format(test_digest)
        }, BadRequest),
        # Digest Only
        ({
            "digest": test_digest
        ...
        ({
            "digest": "docker.io/nginx@{}".format(test_digest)
        }, BadRequest),
    ],
)
...
class TestMakeVulnerabilityResponse:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {
                    "cpe":
                    "cpe:/a:-:foo:4.0:-:~~~python~~",
                    "cpe23":
                    "cpe:2.3:a:-:foo:4.0:-:-:-:-:-:-:~~~python~~",
                    "feed_name":
                    "blah",
                    "feed_namespace":
                    "blah:vulnerabilities",
                    "fixed_in": ["4.5.2"],
                    "link":
                    "http://api:8228/v1/query/vulnerabilities?id=BLAH-123456",
                    "name":
                    "foo",
                    "nvd_data": [{
                        "cvss_v2": {},
            ...
            (
                {
                    ...
                    "fixed_in": ["4.5.2"],
                    "link":
                    "http://api:8228/v1/query/vulnerabilities?id=MEH-123456",
                    "name":
                    "foo",
                    "nvd_data": [{
                        "cvss_v2": {},
    ...
    def test_vulns_dedup_1(self, test_input, expected):
        ...
        a = {
            "cpe_report": [{
                ...
                "fixed_in": [],
                "link":
                "https://nvd.nist.gov/vuln/detail/CVE-1111-1111",
                "name":
                "foo",
                "nvd_data": [{
                    "cvss_v2": {},
    ...
    def test_repeats(self, test_input, test_repeats, expected):
        ...
        a = {
            "cpe_report":
            [test_input.copy() for counter in range(test_repeats)],
            "image_id": "xyz",
            "legacy_report": {},
        }
...
class TestMakeVulnerabilityReport:
    ...
    @pytest.mark.parametrize(
        "test_input",
        [
            pytest.param([NVDReference(vulnerability_id="CVE-x", cvss=[])],
                         id="empty-list"),
            pytest.param([NVDReference(vulnerability_id="CVE-x", cvss=None)],
                         id="none"),
            pytest.param(
                [
    ...
    def test_get_nvd_data_from_nvd_references_multiple_cvss(self):
        ...
        actual_output = api_utils.get_nvd_data_from_nvd_references(
            [test_input])
    ...
    def test_get_vendor_data_from_vulnerability(self, test_input,
                                                expected_output):
        actual_output = api_utils.get_vendor_data_from_vulnerability(
            test_input)
    ...
    def test_get_nvd_data_from_vulnerability(self, test_input,
                                             expected_output):
