...
grype_db_for_unsupported_distro = GovulnersDBFeedMetadata(groups=[
    {
        "name": "ubuntu:20.04",
        "record_count": 4909
    },
...
class TestGateUtilProvider:
    ...
    def test_oldest_namespace_feed_sync(
        ...
        grype_db_feed_metadata: Optional[GovulnersDBFeedMetadata],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (None, "alpine", "3.10",
             False),  # This one tests no active grypedb
