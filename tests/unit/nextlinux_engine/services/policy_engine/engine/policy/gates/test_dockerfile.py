...
from nextlinux_engine.services.policy_engine.engine.policy.gates import dockerfile
...
effective_user_trigger_tests = [
    {
        ...
        True,
        "expected_msg":
        "User admin found as effective user, which is explicity not allowed",
    },
    {
...
exposed_port_trigger_tests = [
    {
        ...
        True,
        "expected_msg":
        "Dockerfile exposes port (3000) which is in policy file DENIEDPORTS list",
    },
    {
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Dockerfile exposes port (3000) which is not in policy file ALLOWEDPORTS list",
    },
]
...
instruction_check_trigger_tests = [
    {
        ...
        True,
        "expected_msg":
        "Dockerfile directive 'COPY' check '=' matched against '. /app' for line '. /app'",
    },
    {
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Dockerfile directive 'COPY' check 'exists' matched against '' for line '. /app'",
    },
    {
        "trigger_type":
        "instruction_check",
        ...
        True,
        "expected_msg":
        "Dockerfile directive 'VOLUME' not found, matching condition 'not_exists' check",
    },
    {
        "trigger_type": "instruction_check",
        "trigger_params": {
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Dockerfile directive 'COPY' check 'like' matched against '. /' for line '. /app'",
    },
    {
        "trigger_type": "instruction_check",
        "trigger_params": {
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Dockerfile directive 'COPY' check 'not_like' matched against '. /usr' for line '. /app'",
    },
    {
        "trigger_type": "instruction_check",
        "trigger_params": {
...
def test_variable_trigger_when_dockerfile_present(dockerfile_gate,
                                                  make_trigger, exec_context,
                                                  create_image, test_context):
    image = create_image(test_context.get("dockerfile_mode", "actual"))
    trigger = make_trigger(test_context["trigger_type"],
                           test_context.get("trigger_params", {}))
