...
image_metadata_attribute_contexts = [
    {
        ...
        True,
        "expected_msg":
        "Attribute check for attribute: 'size' check: '>' check_value: '0' matched image value: '141455360'",
    },
    {
        "trigger_params": {
            "attribute": "size",
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Attribute check for attribute: 'architecture' check: 'like' check_value: 'amd64' matched image value: 'amd64'",
    },
    {
        "trigger_params": {
            "attribute": "architecture",
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Attribute check for attribute: 'os_type' check: 'not_exists' check_value: '' matched image value: 'None'",
    },
    {
        "trigger_params": {
            "attribute": "distro",
        ...
        True,
        "expected_msg":
        "Attribute check for attribute: 'distro' check: 'in' check_value: 'debian,centos' matched image value: 'debian'",
    },
    {
        "trigger_params": {
            "attribute": "distro",
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Attribute check for attribute: 'distro_version' check: '=' check_value: '10' matched image value: '10'",
    },
    {
        "trigger_params": {
            "attribute": "distro_version",
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Attribute check for attribute: 'like_distro' check: 'exists' check_value: '' matched image value: 'debian'",
    },
    {
        "trigger_params": {
        ...
        True,
        "expected_msg":
        "Attribute check for attribute: 'layer_count' check: '>=' check_value: '5' matched image value: '5'",
    },
    {
        "trigger_params": {
            "attribute": "layer_count",
...
def test_image_metadata_attribute_check_trigger(
    ...
    if test_context["expected_fire"]:
        ...
        assert attribute_check_trigger.fired[0].msg == test_context[
            "expected_msg"]
    else:
