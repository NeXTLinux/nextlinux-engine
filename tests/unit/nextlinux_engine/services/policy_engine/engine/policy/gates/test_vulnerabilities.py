...
<<<<<<< HEAD:tests/unit/nextlinux_engine/services/policy_engine/engine/policy/gates/test_vulnerabilities.py
    GrypeProvider,
    LegacyProvider,
)
...
>>>>>>> master:tests/unit/anchore_engine/services/policy_engine/engine/policy/gates/test_vulnerabilities.py
)
