...
from nextlinux_engine.db.entities.policy_engine import Image, ImagePackage
from nextlinux_engine.services.policy_engine.engine.policy.gate import ExecutionContext
from nextlinux_engine.services.policy_engine.engine.policy.gates import licenses
...
full_match_test_contexts = [
    {
        ...
        True,
        "expected_msg":
        "LICFULLMATCH Packages are installed that have blacklisted licenses: git(BSD-2-clause)",
    },
    {
        "licenses":
        "BSD-2-clause,Boost",
        ...
        True,
        "expected_msg":
        "LICFULLMATCH Packages are installed that have blacklisted licenses: git(BSD-2-clause), git(Boost)",
    },
    {
        "licenses":
        "BSD-3-clause,Boost",
        ...
        True,
        "expected_msg":
        "LICFULLMATCH Packages are installed that have blacklisted licenses: git(Boost), gnupg(BSD-3-clause)",
    },
    {
        "licenses":
        "LGPL-2.1+",
        ...
        True,
        "expected_msg":
        "LICFULLMATCH Packages are installed that have blacklisted licenses: git(LGPL-2.1+), gnupg(LGPL-2.1+)",
    },
    {
        "licenses": "no-match",
        "expected_fire": False,
...
def test_full_match_trigger(licenses_gate, exec_context, image, test_context):
    full_match_trigger = licenses.FullMatchTrigger(
        parent_gate_cls=licenses_gate.__class__,
        licenses=test_context["licenses"])
...
substring_match_test_contexts = [
    {
        ...
        True,
        "expected_msg":
        "LICSUBMATCH Packages are installed that have blacklisted licenses: gnupg(RFC-Reference)",
    },
    {
        "licenses":
        "LGPL",
        ...
        True,
        "expected_msg":
        "LICSUBMATCH Packages are installed that have blacklisted licenses: git(LGPL-2.1+), git(LGPL-2+), gnupg(LGPL-2.1+), gnupg(LGPL-3+)",
    },
    {
        "licenses": "GNU",
        "expected_fire": False,
...
def test_substring_match_trigger(licenses_gate, exec_context, image,
                                 test_context):
