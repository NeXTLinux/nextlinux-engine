...
from nextlinux_engine.services.policy_engine.engine.policy.gates import retrieved_files
...
def test_file_not_stored_trigger(
    ...
    assert base_retrieve_file_trigger_assertions(file_not_stored_trigger,
                                                 test_context)
...
file_content_regex_test_contexts = [
    {
        ...
        True,
        "expected_msg":
        "Content regex '.*bash' check 'match' found in retrieved file '/etc/passwd'",
    },
    {
        "trigger_params": {
            "path": "/etc/passwd",
    ...
    },
    {
        ...
        True,
        "expected_msg":
        "Content regex 'expect_fail' check 'no_match' found in retrieved file '/usr/local/lib/ruby/gems/2.3.0/'",
    },
]
...
def test_policy_validation_error(make_file_content_regex_match_trigger,
                                 params):
