...
from nextlinux_engine.services.policy_engine.engine.policy.gates import always
...
def test_always_fire_trigger(always_gate, always_fire_trigger, exec_context,
                             image):
