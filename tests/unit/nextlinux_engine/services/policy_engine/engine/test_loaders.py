...
class TestLoadingPythonCPEs:
    ...
    ANALYSIS_DATA = {
        "package_list": {
            "pkgs.python": {
                "base": {
                    "/usr/local/lib/python3.9/site-packages/wheel":
...
class TestLoadingGemsCPEs:
    ...
    ANALYSIS_DATA = {
        "package_list": {
            "pkgs.gems": {
                "base": {
                    "/usr/lib/ruby/gems/2.7.0/specifications/default/zlib-1.1.0.gemspec":
                    '{"cpes":["cpe:2.3:a:*:zlib:1.1.0:*:*:*:*:*:*:*"],"license":"BSD-2-Clause","licenses":["BSD-2-Clause"],"location":"/usr/lib/ruby/gems/2.7.0/specifications/default/zlib-1.1.0.gemspec","origin":"Yukihiro Matsumoto,UENO Katsuhiro","name":"zlib","type":"GEM","versions":["1.1.0"]}'
                }
            }
        }
    }
...
class TestLoadingNpmsCPEs:
    ...
    ANALYSIS_DATA = {
        "package_list": {
            "pkgs.npms": {
                "base": {
                    "/usr/lib/node_modules/npm/node_modules/yargs-parser/package.jsonl":
                    '{"cpes":["cpe:2.3:a:*:yargs-parser:9.0.2:*:*:*:*:*:*:*"],"license":"ISC","licenses":["ISC"],"location":"/usr/lib/node_modules/npm/node_modules/yargs-parser/package.json","origin":"Ben Coe <ben@npmjs.com>","name":"yargs-parser","type":"NPM","versions":["9.0.2"]}'
                }
            }
        }
    }
