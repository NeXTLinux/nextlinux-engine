...
class TestExtractPythonContent:
    ...
    def test_valid_data(self):
        extracted_content = helpers.extract_python_content(
            self.IMAGE_DATA_STRUCTURE)
...
class TestMakeResponseError:
        ...
        pytest.param(
            {
                ...
                TestException(
                    "testexception",
                    nextlinux_error_json=
                    '{"message": "test", "httpcode": 500, "detail": {"error_codes": [404]}}',
                ),
                "in_httpcode":
                400,
                "details":
    ...
    def test_make_response_error(self, param):
        actual = helpers.make_response_error(param["errmsg"],
                                             param["in_httpcode"],
                                             param["details"])
