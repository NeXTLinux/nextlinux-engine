    ...
    "signatures": [{
        "header": {
            "jwk": {
                "crv": "P-256",
                "kid":
                "FLMC:ZNUX:YO6P:5VYR:V3ZS:VB4L:3G3S:3L45:DEMX:TPJY:YKUP:TQLO",
                "kty": "EC",
        ...
        "signature":
        "ID32d-GIWR20nmGfE2MtZ7AUEw3H5-f8SZYotsn_YYDfXMPjQnNTSy1OUjoomN-whmEDDkZxjW1Tsgv3pbBxyA",
        "protected":
        "eyJmb3JtYXRMZW5ndGgiOjIwMzE3LCJmb3JtYXRUYWlsIjoiQ24wIiwidGltZSI6IjIwMTktMDEtMjNUMDE6MTM6NDdaIn0",
    }],
}
...
cloudfleet_expected_layer_ids.reverse(
)  # Copied here in order of manifest, but output from handler is in dockerfile order, so reverse this
...
cloudfleet_expected_history = [
    ...
    },
    {
        ...
        "CreatedBy":
        "/bin/sh -c #(nop) ADD file:7c5fd1b31307655c5d6f8002a5e5a64ec0890bcb29a67d645fa2cbde03296746 in /etc/nginx/conf.d/default.conf",
        "Size": 1096,
        "Comment": "",
        "Tags": [],
    },
    ...
    },
    {
        ...
        "CreatedBy":
        "/bin/sh -c apt-get update && apt-get install -y nginx-extras",
        "Size": 71974941,
        "Comment": "",
        "Tags": [],
    },
    ...
    },
    {
        ...
        "CreatedBy":
        "/bin/sh -c #(nop) ADD file:96977352301efe982eb2ed967416521e4bf09e96c7f7d6fb06c63edebe91d785 in /",
        "Size": 125119001,
        "Comment": "",
        "Tags": [],
    },
...
nginx_manifest = {
    ...
    "config": {
        ...
        7474,
        "digest":
        "sha256:daee903b4e436178418e41d8dc223b73632144847e5fe81d061296e667f16ef2",
    },
    "layers": [
        {
            "mediaType":
...
nginx_image_config = {
    "created":
    "2020-11-25T00:30:19.011398516Z",
    "architecture":
    "amd64",
    "os":
    "linux",
    ...
    "history": [
        {
            "created":
            "2020-11-17T20:21:17.570073346Z",
            "created_by":
...
def test_dockerv1manifestmetadata(manifest, expected_history,
                                  expected_layer_ids):
