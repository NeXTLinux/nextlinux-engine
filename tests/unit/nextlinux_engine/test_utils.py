...
def test_run_command_list_with_piped_input(cmd_list, input_data,
...
def test_run_check_with_input(cmd_list, input_data, expected_stdout,
                              expected_stderr):
    # Function under test
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                {
                    "input":
                    "cpe23:a:part:vendor:product:version:update:edition:language:sw_edition:target_sw:target_hw:other",
                    "expected":
                    CPE(
                        part="part",
                        vendor="vendor",
            ...
            pytest.param(
                {
                    "input":
                    "cpe23:a:part:vendor:product:version:update:edition:language:sw_edition:target_sw:target_hw:other\\:other",
                    "expected":
                    CPE(
                        part="part",
                        vendor="vendor",
            ...
            pytest.param(
                {
                    "input":
                    "cpe23:a:part:vendor:product:version:update:edition:language:sw_edition:target_sw:target_hw:other:other2",
                    "expected":
                    None,
                    "expectedError":
                    Exception(
