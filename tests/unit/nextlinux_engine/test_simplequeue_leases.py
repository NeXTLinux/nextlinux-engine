...
@pytest.mark.skip(
    reason=
    "Disabled temporarily pending work to remove db requirement from internal client init"
)
def test_run_target_with_lease_ok():
    ...
    IdentityManager._credential_cache.cache_it(
        "nextlinux-system", HttpBasicCredential("nextlinux-system",
                                                "somepass"))
