...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/handlers/test_java.py
from nextlinux_engine.analyzers.syft.handlers.java import save_entry
========
from nextlinux_engine.analyzers.gosbom.handlers.java import save_entry
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/handlers/test_java.py
