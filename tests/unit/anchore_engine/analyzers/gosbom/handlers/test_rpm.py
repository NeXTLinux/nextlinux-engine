...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/handlers/test_rpm.py
from nextlinux_engine.analyzers.syft.handlers.rpm import save_entry, _all_packages
========
from nextlinux_engine.analyzers.gosbom.handlers.rpm import save_entry, _all_packages
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/handlers/test_rpm.py
