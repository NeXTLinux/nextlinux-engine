...
<<<<<<<< HEAD:tests/unit/nextlinux_engine/analyzers/syft/handlers/test_debian.py
from nextlinux_engine.analyzers.syft.handlers.debian import save_entry, _all_packages
========
from nextlinux_engine.analyzers.gosbom.handlers.debian import save_entry, _all_packages
>>>>>>>> master:tests/unit/anchore_engine/analyzers/gosbom/handlers/test_debian.py
