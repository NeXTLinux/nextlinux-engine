...
if [[ -d "/home/nextlinux/certs" ]] && [[ ! -z "$(ls -A /home/nextlinux/certs)" ]]; then
    mkdir -p /home/nextlinux/certs_override/python
    mkdir -p /home/nextlinux/certs_override/os
    ### for python
    cp /usr/local/lib/python3.6/site-packages/certifi/cacert.pem /home/nextlinux/certs_override/python/cacert.pem
