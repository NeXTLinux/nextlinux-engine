<<<<<<<< HEAD:nextlinux_engine/analyzers/syft/handlers/gem.py
from nextlinux_engine.analyzers.syft.handlers.common import save_entry_to_findings
========
from nextlinux_engine.analyzers.gosbom.handlers.common import save_entry_to_findings
>>>>>>>> master:nextlinux_engine/analyzers/gosbom/handlers/gem.py
...
def save_entry(findings, engine_entry, pkg_key=None):
    ...
    save_entry_to_findings(findings, engine_entry, "pkgs.gems", pkg_key)


def translate_and_save_entry(findings, artifact):
    """
    Handler function to map gosbom results for the gem package type into the
