...
def save_entry_to_findings(findings: Union[dict, DefaultDict], entry: dict,
                           pkg_type: str, pkg_key: str) -> None:
    """
    ...
    :param findings: analysis report. Either actual report or a place hodler default dict used by gosbom converted
    ...
    try:
        ...
        # This happens if artifact type not found by gosbom but is present in the hints file
