<<<<<<<< HEAD:nextlinux_engine/analyzers/syft/handlers/golang.py
...
>>>>>>>> master:nextlinux_engine/analyzers/gosbom/handlers/golang.py
...
def translate_and_save_entry(findings, artifact):
    """
    Handler function to map gosbom results for the go-module type into the engine "raw" document format.
    """
