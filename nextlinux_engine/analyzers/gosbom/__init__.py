...
def catalog_image(
    ...
    """
    gosbom_analysis = run_gosbom(tmp_dir_path=tmp_dir, oci_image_dir_path=image_oci_dir)
    output_adapter = FilteringEngineAdapter(gosbom_analysis, package_filtering_enabled)
