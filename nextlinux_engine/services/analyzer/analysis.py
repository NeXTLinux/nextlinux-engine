...
from nextlinux_engine.common.models.schemas import AnalysisQueueMessage, ValidationError
...
from nextlinux_engine.subsys import events, logger
from nextlinux_engine.subsys.events.util import (
...
def perform_analyze(
    ...
    with nextlinux_engine.clients.localnextlinux_standalone.get_nextlinuxlock(
        ...
        result = localnextlinux_standalone.analyze_image(
            account,
            registry_manifest,
            image_record,
            tmpdir,
