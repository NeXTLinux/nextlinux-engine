...
from nextlinux_engine.services.apiext.api.controllers.utils import (  # make_response_vulnerability,
    make_response_vulnerability_report,
    normalize_image_add_source,
    validate_image_add_source,
)
from nextlinux_engine.subsys import logger, taskstate
    ...
    try:
        ...
        if source.get("import"):
            ...
            if source.get("archive"):
                ...
                tag = img_source["tag"]
                digest_info = nextlinux_engine.util.docker.parse_dockerimage_string(
                ...
                if ts:
                    try:
                        ts = nextlinux_engine.util.time.rfc3339str_to_epoch(ts)
                    except Exception as err:
...
def initialize_subscriptions(
    ...
    for image_detail in image_record["image_detail"]:
        ...
        sub_types = nextlinux_engine.common.tag_subscription_types
