...
from nextlinux_engine.db.entities.catalog import ImageImportOperation, ImportState
                    ...
                    for repotag in repotags:
                        try:
                            ...
                            with db.session_scope() as dbsession:
                                ...
                                for (
                                    stype
                                ) in nextlinux_engine.common.tag_subscription_types:
                                    activate = False
                ...
                try:
                    with nextlinux_engine.subsys.metrics.get_summary_obj(
                        ...
                        with db.session_scope() as dbsession:
                            ...
                            db_nextlinux.update_record(nextlinux_record, session=dbsession)
