...
class VulnerabilitySummary:
    ...
    Copied from summary_elements of nextlinux_engine/utils.py
    """
...
def get_normalized_map_from_table(table) -> Dict[Tuple, VulnerabilitySummary]:
    ...
    Partially lifted from nextlinux_engine/utils.py. Can be deprecated and removed after legacy format is no longer widely used
...
def diff_identity_summary_maps(
    ...
    Borrowed from nextlinux_engine/utils.py item_diffs()
    """
