...
from nextlinux_engine.common.models.policy_engine import CVSS, NVDReference
from nextlinux_engine.db.entities.common import nextlinux_now_datetime, truncate_index_name
...
class GrypeDBFeedMetadata(Base):
    ...
    created_at = Column(DateTime, default=nextlinux_now_datetime, nullable=False)
    last_updated = Column(
        DateTime,
        default=nextlinux_now_datetime,
        onupdate=nextlinux_now_datetime,
        nullable=False,
    )
