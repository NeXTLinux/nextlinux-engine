---
title: "Nextlinux Engine Release Notes - Version 0.5.0"
linkTitle: "0.5.0"
weight: 89
---

## Nextlinux Engine 0.5.0

Nextlinux Engine 0.5.0 includes many new features, bug fixes and improvements.  The latest summary can always be found in the Nextlinux Engine [CHANGELOG](https://github.com/nextlinux/nextlinux-engine/blob/master/CHANGELOG.md) on github.
