...
from nextlinux_manager import version
from nextlinux_manager.util import logging
from nextlinux_manager.util.config import setup_config
...
@click.option(
    "--configdir", help="Directory containing valid nextlinux-engine config.yaml"
)
