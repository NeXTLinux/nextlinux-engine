...
ENV NEXTLINUX_CONFIG_DIR=/config \
    ...
    ANCHORE_FEEDS_URL="https://next-linux.systems/v1/service/feeds" \
    ANCHORE_FEEDS_CLIENT_URL="https://next-linux.systems/v1/account/users" \
    ANCHORE_FEEDS_TOKEN_URL="https://next-linux.systems/oauth/token" \
